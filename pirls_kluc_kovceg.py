...
MCQ_ANSWERS = [
    ...
    ("13", "Б", "Пронаоѓање експлицитни информации")
]
...
OPEN_ENDED_ANSWERS = [
    ...
    {"question": "14. Доказ за досада.", "points": {"1 поен": "Селото му значело само едно: досада. Или: Седел на тремот и воздивнувал."}},
    {"question": "15. Најголемо богатство.", "points": {"2 поени": "Бидејќи спомените се повредни од златото и остануваат засекогаш."}}
]
