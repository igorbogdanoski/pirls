...
const inclusiveData = {
  ...
  kaja: {
    ...
    ], text: "Каја сакаше да биде пронаоѓач и постојано црташе идеи во својата тетратка.", textSq: 'Kaja donte të bëhej një shpikëse dhe vizatonte ide në fletoren e saj.' },
    ...
    ], text: "Каја работи во својата соба.", textSq: 'Kaja punon në dhomën e saj.' },
  ...
  shovel: {
    ...
    ], text: "Чичкото со лопатата секој ден работеше во својата градина.", textSq: 'Xhaxhai me lopatë punonte çdo ditë në kopshtin e tij.' },
    ...
    coloring: [
      { id: 1, img: imgs.shovel.coloring[1,
    ...
    ], text: "Работа во градината.", textSq: 'Punë në kopsht.' },
  ...
  lynx: {
    ...
    ], text: "Балканскиот рис е ретко и загрозено животно.", textSq: 'Rrëqebulli i Ballkanit është një kafshë e rrallë dhe e rrezikuar.' },
    ...
    ], text: "Рис како седи на карпа.", textSq: 'Rrëqebulli i ulur mbi shkëmb.' },
  ...
  watchmaker: {
    puzzle: [
      { id: 1, img: imgs.watchmaker.puzzle[1,
    ...
    ], text: "Стариот часовничар живееше сам во својата тивка работилница.", textSq: 'Sahatçiu i vjetër jetonte i vetëm në punishten e tij të qetë.' },
    ...
    coloring: [
      { id: 1, img: imgs.watchmaker.coloring[1,
    ...
    ], text: "Работилница полна со часовници.", textSq: 'Punishtja plot me sahatë.' },
  ...
  kite: {
    ...
    ], text: "Бојан со денови правеше голем, шарен змеј за летање.", textSq: 'Bojani bëri një balonë të madhe dhe me ngjyra për ditë të tëra.' },
    ...
    ], text: "Бојан во својата работилница.", textSq: 'Bojani në punishten e tij.' },
  ...
  rabbit: {
    ...
    ], text: "Зајакот уживаше во мирното попладне во шумата.", textSq: "Lepuri po shijonte pasditen e qetë në pyll." },
    ...
    coloring: [
      { id: 1, img: imgs.rabbit.coloring[1,
    ...
    ], text: "Зајакот во шумата.", textSq: "Lepuri në pyll." },
  ...
  puffins: {
    puzzle: [
      { id: 1, img: imgs.puffins.puzzle[1,
    ...
    ], text: "Морските папагалчиња се враќаат на островот за да снесат јајца.", textSq: "Papagajtë e detit kthehen në ishull për të bërë vezë." },
    ...
    coloring: [
      { id: 1, img: imgs.puffins.coloring[1,
    ...
    ], text: "Папагалчиња на гребенот.", textSq: "Papagajtë në shkëmb." },
  ...
  eagle: {
    ...
    ], text: "Еден фармер најде мало паднато орле на планината.", textSq: 'Një fermer gjeti një shqiponjë të vogël të rënë në mal.' },
    ...
    coloring: [
      { id: 1, img: imgs.eagle.coloring[1,
    ...
    ], text: "Малото орле во гнездото.", textSq: 'Shqiponja e vogël në fole.' },
  ...
  pita: {
    ...
    ], text: "Баба и внукот направија вкусна пита.", textSq: 'Gjyshja dhe nipi bënë një pite të shijshme.' },
    ...
    ], text: "Месење на питата.", textSq: 'Zënia e pites.' },
  ...
  pot: {
    ...
    ], text: "Царот им даде на сите деца по едно семе да го засадат.", textSq: 'Perandori u dha të gjithë fëmijëve nga një farë për ta mbjellë.' },
    ...
    ], text: "Ли ја подготвува земјата.", textSq: 'Li përgatit tokën.' },
  ...
  lakestar: {
    puzzle: [
      { id: 1, img: imgs.lakestar.puzzle[1,
    ...
    ], text: "Една ноќ, мала ѕвезда падна во езерото.", textSq: 'Një natë, një yll i vogël ra në liqen.' },
    ...
    coloring: [
      { id: 1, img: imgs.lakestar.coloring[1,
    ...
    ], text: "Ѕвездена ноќ над езерото.", textSq: 'Natë me yje mbi liqen.' },
  ...
  lambe: {
    ...
    ], text: "Дедо Ламбе секој ден им носеше храна на своите пријатели - глувците.", textSq: 'Gjyshi Lambe u sillte ushqim miqve të tij - miuve çdo ditë.' },
    ...
    coloring: [
      { id: 1, img: imgs.lambe.coloring[1,
    ...
    ], text: "Дедо Ламбе прави играчки.", textSq: 'Gjyshi Lambe bën lodra.' },
